...
class RashodiImportingTestCases(unittest.TestCase):
    ...
    prijepolje_counts_of_programs = {
        ...
        "ЈАВНИ РЕД И БЕЗБЕДНОСТ ПРОГРАМ 15-ФУНКЦИОНИСАЊЕ ЛОК. САМОУПРАВЕ": 5,
